  ...
  const services = [
    {
      ...
      icon: <Smartphone className="w-10 h-10 text-blue-500 dark:text-blue-400" />,
    },
    {
      id: 2,
    ...
    },
    {
      ...
      icon: <Server className="w-10 h-10 text-blue-500 dark:text-blue-400" />,
    },
    {
      id: 4,
      name: t("services.training"),
      description: t("services.training.desc"),
      icon: <Laptop className="w-10 h-10 text-blue-500 dark:text-blue-400" />,
    },
  ]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative overflow-hidden rounded-xl card-glass p-6 hover:shadow-lg transition-all duration-300 group"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-blue-700/5 backdrop-blur-sm opacity-80"></div>

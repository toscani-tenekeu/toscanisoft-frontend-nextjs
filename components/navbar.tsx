  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-4">
          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="language-dropdown">
                <DropdownMenuItem onClick={() => setLanguage("en")} className="language-dropdown-item">
                  English
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setLanguage("fr")} className="language-dropdown-item">
                  Français
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 p-4 rounded-lg card-glass">
              ...
              <div className="flex items-center space-x-4 pt-2 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Button
                    ...
                    className={`${language === "en" ? "text-blue-600 dark:text-blue-400" : "text-gray-800 dark:text-white"}`}
                  >
                    EN
                  </Button>
                  <Button
                    ...
                    className={`${language === "fr" ? "text-blue-600 dark:text-blue-400" : "text-gray-800 dark:text-white"}`}
                  >
                    FR
                  </Button>
                </div>
